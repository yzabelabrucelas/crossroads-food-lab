...
<div class="wrapper">
  ...
  <?php include("sidebar/side-reservation_pending.php");?>
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0">
              <div class="mailbox-read-info">
                  <?php  
                                    ...
                                    $res_id = $_GET['view_reservation'];
                                    $get = "select * from reservation where res_id = '$res_id'";
            ...
            <div class="card-footer">
              <div class="float-right">
                <button type="button" class="btn btn-success btn-lg" data-toggle="modal" href="#replyModal">Confirm <i class="fa fa-check"></i></button>
               </div>
...
<input type="text" class="form-control" value="<?php echo $email?>" name="email">
            ...
            <div class="form-group">
              <input class="form-control" rows="3" name="message" type="hidden" onkeyup="countChar(this)" value=" <h3><b>Dear <?php echo $fname; ?> <?php echo $lname; ?>,</b></h3>
                  
                <br><br><br>
                <h1><b>Thank you for choosing Crossroads Food Lab!</b></h1>
                <br>
               We have received your reservation request. Your reservation has been confirmed. Please print this email to be presented to the staff to accomodate your reservation. The details of the reservation are below:
                <br><br><br>
                <b>Reservation ID:</b> <?php echo $res_id;?>
                <br>
                <b>Reserved Date and Time:</b> <?php echo $res_date;?> from <?php echo $res_time;?>
                ...
                <br> You are receiving this email because you made a reservation via our website. Please do not reply.</textarea>" required>
