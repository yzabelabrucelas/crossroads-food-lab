  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Confirmed Online Reservation</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="col-md-9">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Read Confirmed Reservation</h3>
            ...
            <div class="card-body p-0">
              <div class="mailbox-read-info">
                                    ...
                                    $up = "update reservation set status='finished' where res_id='$res_id'";
                                    ...
                                    ?>
                <form method="post" action="reservation_confirmed.php" enctype="multipart/form-data">
              ...
              <!-- /.mailbox-read-info -->
                  ...
                  <b>Customer Name:</b> <?php echo $fname;?> <?php echo $lname;?>
                  <br>
                  ...
                  <br>
                  <b>Update Status to:</b>  <select name="status"><option value="Finished">Finished</option></select>
                  <?php }}  ?>
                    <br> <br> <br>
                   <input type="submit" value="Confirm Reservation" name="update" class="btn btn-lg btn-block btn-success">
              </div>
            </form>
