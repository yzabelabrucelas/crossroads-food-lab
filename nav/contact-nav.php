...
$db=mysqli_select_db("crossroads_crossroa", $connection);
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a style="font-family: 'Montserrat', sans-serif;color:black;" href="menu.php">Menu</a></li>
                           ...
                           <li><a style="font-family: 'Montserrat', sans-serif;color:black;" href="menu.php">Gallery</a></li>
<li><a style="font-family: 'Montserrat', sans-serif;color:black;" href="about.php">About</a></li>

          <li class="active"><a style="font-family: 'Montserrat', sans-serif;color:black;" href="contact.php">Reach Us</a></li>
