...
<div class="wrapper"><!--wrapper-->
  ...
  <?php include("sidebar/side-reports_walkin-res.php");?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
      <div class="col-sm-6">
            <h1 class="m-0 text-dark">Walkin Reservation Reports</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item">Reports</li>
              <li class="breadcrumb-item active">Walkin Reservations</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
 ...
 <table id="example" class="display table table-bordered table-striped" style="width:100%">
                <thead>
                  <tr>
                    ...
                    <td><center>Pax</center></td>
                    <td><center>Reservation Date & Time</center></td>
               ...
               <tbody>
                  ...
                  <tr>
                    ...
                    <td><center><?php echo $res_id;?></center></td>
                    <td><center><?php echo $fname;?> <?php echo $lname;?></center></td>
                    <td><center><?php echo $pax;?></center></td>
