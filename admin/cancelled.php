...
<div class="wrapper">
  ...
  <?php include("sidebar/side-reservation_cancelled.php");?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Cancelled Online Reservations</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item">Reservation</li>
              <li class="breadcrumb-item active">Cancelled Online Reservations</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card-body">
             <table id="example1" class="table table-bordered hoverTable">
               ...
               <tbody>
                     <?php  
                                    include("includes/db.php");
                                    $get = "SELECT * from reservation WHERE status='cancelled' ORDER BY sent_date ASC";
