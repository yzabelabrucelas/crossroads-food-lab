  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Pending Online Reservations</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item">Reservation</li>
              <li class="breadcrumb-item active">Pending Online Reservations</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <table id="example1" class="table table-bordered hoverTable">
               ...
               <tbody>
                     <?php  
                                   ...
                                   $get = "SELECT * from reservation WHERE status='to be processed' ORDER BY sent_date ASC";
                  ...
                  <tr>
                    ...
                    <td><center><a href="read-reservation_pending.php?view_reservation=<?php echo "$res_id"; ?>"><?php echo $res_id?></a></center></td>
