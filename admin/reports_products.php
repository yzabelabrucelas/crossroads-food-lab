...
<div class="wrapper"><!--wrapper-->
  ...
  <?php include("sidebar/side-reports_products.php");?>
...
<br>
 ...
 <table id="example" class="display table table-bordered table-striped" style="width:100%">
               ...
               <tbody>
                     <?php  
                                    include("includes/db.php");
                                    $get_inq = "SELECT * from menu";
                                    $run_inq = mysqli_query($con, $get_inq);
                                    $i = 0;

                                    while ($row_inq = mysqli_fetch_array($run_inq)) 
                                    {
                                        $menu_ID = $row_inq['menu_ID'];
                                        $menu_name = $row_inq['menu_name'];
                                        $packages = $row_inq['packages'];
                                        $details = $row_inq['details'];
                                        $i++;
                                    ?>
                  <tr>
                    
                    <td><center><?php echo $menu_ID;?></center></td>
                    <td><center><?php echo $menu_name;?></center></td>
                    <td><center><?php echo $packages;?></center></td>
