...
<div class="wrapper"><!--wrapper-->
  ...
  <?php include("sidebar/side-products.php");?>
...
<button type="button" style="float:right; margin-bottom:20px;"  class="btn btn-info btn-lg" data-toggle="modal" data-target="#addModal">Add New Product</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
              ...
              <form class="form-horizontal" method="post" action="product_save.php" enctype='multipart/form-data'>

                    <div class="form-group">
                      <div class="col-lg-12"> 
                     <input type="text" class="form-control" name="menu_name" placeholder="Product Name" required>
                      </div>
                  </div> 
...
?>                      
 ...
 <input type="checkbox" name="packages[]" value="<?php echo $package_title;?>"> <?php echo $package_title;?> <br>
 <?php }?>
...
?>  
            ...
            <td><center><img style="height:150px;width:150px" src="images/menu/<?php echo $menu_image;?>"></center></td>
            <td style="font-size: 20px"><center><?php echo $menu_name;?></center></td>
            <td style="font-size: 20px"><center><?php echo $packages;?></center></td>
            <td style="font-size: 20px"><center><?php echo $details;?></center></td>
                        <td><center>            

                      <a href="#updateModal" class="btn btn-info btn-lg" data-target="#updateModal<?php echo $menu_ID;?>" data-toggle="modal"> <i class="fa fa-edit"></i></a>   
                       <a href="#deleteModal" class="btn btn-danger btn-lg" data-target="#deleteModal<?php echo $menu_ID;?>" data-toggle="modal"> <i class="fa fa-trash-o"></i></a>  
         

                        </center></td>
                        </tr>
<!-- Modal -->
<div id="updateModal<?php echo $menu_ID;?>" id="updateModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
...
<input type="hidden" name="menu_ID" value="<?php echo $menu_ID;?>">
                  ...
                  <div class="form-group">
<div class="col-lg-12"> 
                     <input type="text" class="form-control" name="menu_name" value="<?php echo $menu_name;?>" placeholder="Product Name" required>
</div>
</div> 
...
<div class="col-lg-12"> 
                        <label>Packages</label>
                       <select multiple="multiple" class="form-control select2" readonly style="height: 150px">
                           <?php
                              $result = mysqli_query($con,"SELECT * FROM package"); 
                                  while ($row = mysqli_fetch_assoc($result)){

                                ?>
                                <option value="<?php echo $row['package_title'];?>"><?php echo $row['package_title'];?></option>
                        <?php } ?>
                        </select>
                        <br>
                    <textarea class="form-control" name="packages"><?php echo "$packages"; ?></textarea>
</div>
</div> 
 ...
 <textarea class="form-control" name="details"><?php echo "$details"; ?></textarea>
                  ...
                  <div class="form-group">
<div class="col-lg-12"> 
<input type="hidden" class="form-control" id="image" name="image1" value="<?php echo $menu_image;?>"> 
...
<div id="deleteModal<?php echo $menu_ID;?>"  class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
              ...
              <form class="form-horizontal" method="post">
                  <input type="hidden" class="form-control" name="menu_ID" value="<?php echo $menu_ID;?>">
...
<?php
  ...
  // sending query
  mysqli_query($con,"DELETE FROM menu WHERE menu_ID='$menu_ID'")
  or die(mysqli_error());
